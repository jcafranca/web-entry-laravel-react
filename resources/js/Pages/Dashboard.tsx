...
import { ThemesSwitcher } from "@/Customs/Themes/Themes-Selector";
import { THEMES } from "@/lib/themes"
import { ThemesStyle } from "@/Customs/Themes/Themes-Style";
import { cn } from "@/lib/utils";
import { DataTable } from "@/Customs/DataTable-Components/DataTable";
import { z } from "zod";
import { mainTableSchema } from "@/types/table-schema";
import { columns } from "@/Customs/MainTable/MainTableColumns";
...
function getTasks() {
    ...
    return z.array(mainTableSchema).parse(data)
}
...
export default function Dashboard() {
    ...
    return (
        <ContainerLayout title="Home">
            <ThemesStyle />
            <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-14 themes-wrapper bg-wrapper">
                <HeaderContent title="Dashboard" subtitle="Your personal dashboard provides easy navigation and clear, real-time updates." />

                <main className="flex flex-col flex-wrap items-start justify-center max-w-6xl gap-6 p-6 mx-auto chart-wrapper sm:flex-row sm:p-8">
                    ...
                    <div className="grid w-full mt-32">
                        <DataTable data={tasks} columns={columns} statuses={statuses} />
                    </div>
                </main>
                <FooterContent />
            </div>
